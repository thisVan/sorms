 ...
 * Clienttype entities. Transaction control of the save(), update() and delete()
...
public class ClienttypeDAO extends HibernateDaoSupport {
	...
	public void save(Clienttype transientInstance) {
		log.debug("saving Clienttype instance");
		try {
	...
	public void delete(Clienttype persistentInstance) {
		log.debug("deleting Clienttype instance");
		try {
	...
	public List findByExample(Clienttype instance) {
	...
	public List findByCtypedesc(Object ctypedesc) {
		return findByProperty(CTYPEDESC, ctypedesc);
	}

	public List findAll() {
		log.debug("finding all Clienttype instances");
		try {
			String queryString = "from Clienttype";
	...
	public void attachDirty(Clienttype instance) {
		log.debug("attaching dirty Clienttype instance");
		try {
	...
	public void attachClean(Clienttype instance) {
		log.debug("attaching clean Clienttype instance");
		try {
