	...
	<div class="container-fluid">
		<div class="navbar-header">
			<button type="button" class="navbar-toggle collapsed"
				...
				<span class="sr-only">系统导航</span> <span class="icon-bar"></span> <span
					class="icon-bar"></span> <span class="icon-bar"></span>
			</button>
			<a class="navbar-brand" href=""><img
				height="26" width="40" src="images/logo.png" alt="新视界传媒科技有限公司" /><span
				style="font-size: x-large;font-weight: bold;">新视界传媒</span>&nbsp;占屏率监控系统</a>
			<ul class="user-menu">
				<li class="dropdown pull-right">
				
				<!-------------------- 新添加的有关消息的管理（上面导航栏的图标）---------------------->
				    <div class="btn-group" style="margin-right:20px;">
					<a href="message.action" class="btn btn-link nav-link" title="消息管理">
				    ...
				    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><svg
							...
							xlink:href="#stroked-male-user"></use></svg> <s:property value="#request.name"/> <span class="caret"></span></a>
					<ul class="dropdown-menu" role="menu">
						...
						<li><a href='<s:url action="setting" namespace="/"/>'><svg class="glyph stroked gear"> <use
									xlink:href="#stroked-gear"></use></svg> 设置</a></li>
