...
<content tag="scripts">
	...
	<script>
//		var renkanshubianhao = <%=request.getAttribute("renkanshubianhao")%>;
    ...
    //    		editurl:"deleteLed.action",
		...
		//		alert(searchFilter);
			    	if(searchFilter.length === 0){
				    	...
				    	"%' or l.ledWeizhi like '%"+searchFilter+"%' or l.ledBofangkaishishijian like '%"+searchFilter+"%' or l.ledBofangjieshushijian like '%"+searchFilter+
				    	"%' or l.state like '%"+"U"+"%')";
