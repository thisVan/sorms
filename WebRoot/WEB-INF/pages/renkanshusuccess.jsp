			...
			<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<div class="login-panel panel panel-default">
					...
					<div class="panel-body">
						...
						<div align="center" style="font-size: larger;">${session.successmessage }<br> 系统将在<span id="jumpTo" style="color: red;font-size: large;">3</span>秒后自动跳转到认刊书填写页面！
							<script type="text/javascript">
								countDown(3, 'renkantypein.action');
							</script>
						</div>
					</div>
				</div>
