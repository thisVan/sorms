						...
						<tbody>
							<tr>
								...
								<td><input name="order.startdate"
									class="form-control input-sm" type="date" max="9999-12-31" id="startdate1"
									value="<s:date name='#order.startdate' format="yyyy-MM-dd" />"></td>
								<td><input name="order.enddate"
									class="form-control input-sm" type="date" max="9999-12-31" id="enddate1"
