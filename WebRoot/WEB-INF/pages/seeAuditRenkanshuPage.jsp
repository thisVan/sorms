                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-1g-12">
                                    ...
                                    <div class="col-md-6 form-group form-inline">
                                        ...
                                        <input class="form-control" id="zhekou" readonly="true"
                                            value='<s:property value="renkanshuaudit.zhekou * 10"/>' />
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-12 col-lg-12 ">
						            <label class="control-label" style=" text-align:left;">审核理由</label>
						     		<textarea class="form-control input-sm" name="auditReason" rows="3" readonly="true">${renkanshuaudit.auditReason}</textarea>
						        </div>
							</div>   
                    	</div>
				</form>
    ...
    var renkanbianhao='<s:property value="renkanshuaudit.renkanbianhao"/>';
        $(document).ready(function() {
            ...
            $("#jqgrid").length > 0 && (t.jqGrid({
            	caption:'上画点位信息',
            	url:"yewuList4SeeRenkanshu.action?renkanbianhao="+renkanbianhao,
            	mtype:"GET",
            ...
            //付款表
             $("#jqgrid_fukuan").length > 0 && (tf.jqGrid({
            	caption:'付款信息',
            	url:"fukuanPage4SeePassedNewRenkanshu.action?renkanbianhao="+renkanbianhao,
            	mtype:"GET",
            	styleUI: 'Bootstrap',//设置jqgrid的全局样式为bootstrap样式
            	shrinkToFit:true,
            	datatype:"json",
