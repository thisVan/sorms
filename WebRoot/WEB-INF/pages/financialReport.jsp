				...
				<div class="panel panel-default">
					<div class="panel-body tabs">
						...
						<ul class="nav nav-pills">
							<li class="active"><a href="hangyestatistic.action">行业分布</a></li>
							<li class=""><a href="yejistatistic.action">行业报表</a></li>
						</ul>
...
<div id="jqgrid-wrapper">
	...
	<div class="tab-content row-fluid example" >
		<div id="pieReport" class="col-md-6">	
		<div id="mainpie" style="width: 100%;height:600px;overflow: visible"></div>
		</div>
		<div id="rankReport" class="col-md-6">	
